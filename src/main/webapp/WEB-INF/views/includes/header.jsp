	...
	<div class="col-2">
		<nav class="nav-sidebar flex-column fixed-top" id="customSidebar">
			...
			<div class="row">
				<div class="bottom-border pd-3" id="profile"
					...
					<div class="card-profile" style="">
						...
						<a href="#multiCollapseUser" class="" data-bs-toggle="collapse"
							role="button" aria-expanded="false"
							aria-controls="multiCollapseUser"
							style="text-decoration: none; color: white;" id="userName"> <img
						...
						<div class="card card-body"
							...
							<ul>
								<a href="/messenger/chat"
									onclick="window.open(this.href, '_blank', 'width=800, height=600'); return false;"><li>메신저</li></a>
								<br>
								<!-- <a href="/messenger"><li>메신저</li></a><br> -->
								<a href="/approval/insert"><li>나의 계정 관리</li></a>
								<br>
								<a href="/approval/list"><li>조직도 보기</li></a>
								<br>
							</ul>
						</div>
						<!-- end card -->
				...
				<div class="col">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a href="#multiCollapseMGR3"
							...
							aria-controls="multiCollapseMGR3"> <svg
									xmlns="http://www.w3.org/2000/svg" width="25" height="25"
									fill="currentColor" class="bi bi-menu-button-fill"
									viewBox="0 0 16 16">
				  <path
				...
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseMGR3">
						<div class="card card-body"
							...
							<ul>
								<a href="/manager/register"><li>계정 생성</li></a>
								<br>
								<a href="/manager/list"><li>계정 관리</li></a>
								<br>
								<!-- <a href="/account/form"><li>계정 양식 설정</li></a><br> -->
								<!-- <a href="/account/{empid}"><li>계정 삭제</li></a><br> -->
								<a href="/manager/retireelist"><li>퇴사자 리스트 관리</li></a>
								<br>
							</ul>
						</div>
					</div>
			...
			<div class="row">
				<div class="col">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a href="#multiCollapseTSK"
							class="nav-link text-white p-3 mb-2 sidebar-link"
							data-bs-toggle="collapse" role="button" aria-expanded="false"
							aria-controls="multiCollapseTSK"><svg
									xmlns="http://www.w3.org/2000/svg" width="25" height="25"
				...
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseTSK">
						<div class="card card-body"
							style="height: 100px; border-width: 0;">
							<ul>
								<a href="/task/pages/all/empty/empty/1"><li>내 업무</li></a>
								<br>
								<a href="/task/pages/all/empty/empty/1"><li>부서별 업무</li></a>
								<br>
							</ul>
						</div>
					</div>
			...
			<div class="row">
				<div class="col">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a href="#multiCollapseSCH"
							class="nav-link text-white p-3 mb-2 sidebar-link"
							data-bs-toggle="collapse" role="button" aria-expanded="false"
							aria-controls="multiCollapseSCH"> <svg
									xmlns="http://www.w3.org/2000/svg" width="25" height="25"
				...
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseSCH">
						<div class="card card-body"
							style="height: 100px; border-width: 0;">
							<ul>
								<a href="/schedule/main"><li>나의 일정</li></a>
								<br>
								<a href="/schedule/main"><li>부서 일정</li></a>
								<br>
								<a href="/schedule/main"><li>회사 일정</li></a>
								<br>
							</ul>
						</div>
					</div>
				...
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseAPR">
						<div class="card card-body"
							style="height: 130px; border-width: 0;">
							<ul>
								<a href="/approval/insert"><li>결재 문서 작성</li></a>
								<br>
								<a href="/approval/list"><li>전체 결재문서함</li></a>
								<br>
								<a href="/approval/receivedList"><li>결재할 문서</li></a>
								<br>
								<a href="#"><li>작성한 결재문서</li></a>
								<br>
							</ul>
						</div>
					</div>
				...
				<div class="col">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a href="#multiCollapseBOA"
							class="nav-link text-white p-3 mb-2 sidebar-link"
							data-bs-toggle="collapse" role="button" aria-expanded="false"
							aria-controls="multiCollapseBOA"> <svg
									xmlns="http://www.w3.org/2000/svg" width="25" height="25"
			...
			<div class="row">
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseBOA">
						<div class="card card-body"
							style="height: 190px; border-width: 0;">
							<ul class="board">
								<a href="/board/new"><li>게시글 등록</li></a>
								<br>
								<a href="/board/newboard"><li>새 게시판 생성</li></a>
								<br>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col">
						<ul class="navbar-nav flex-column mt-4">
							<li class="nav-item"><a href="#multiCollapseDOC"
								class="nav-link text-white p-3 mb-2 sidebar-link"
								data-bs-toggle="collapse" role="button" aria-expanded="false"
								aria-controls="multiCollapseDOC"> <svg
										xmlns="http://www.w3.org/2000/svg" width="25" height="25"
					...
					<div class="col">
						<div class="collapse multi-collapse" id="multiCollapseDOC">
							<div class="card card-body"
								style="height: 130px; border-width: 0;">
								<ul>
									<a href="/document/myApproval/1"><li>결재문서함</li></a>
									<br>
									<a href="/document/myDoc/1"><li>내가 쓴 게시물</li></a>
									<br>
									<a href="/document/scrap/1"><li>스크랩 문서함</li></a>
									<br>
									<a href="/document/deptDoc/1"><li>부서수신함</li></a>
									<br>
								</ul>
							</div>
						</div>
				...
				<div class="sidebar-booking">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a
							class="nav-link text-white p-3 mb-2 sidebar-link"
							data-bs-toggle="collapse" href="#multiCollapseBOK" role="button"
							aria-expanded="false" aria-controls="multiCollapseBOK"> <svg
									xmlns="http://www.w3.org/2000/svg" width="25" height="25"
						...
						<div class="col">
							<div class="collapse multi-collapse" id="multiCollapseBOK">
								<div class="card card-body"
									style="height: 100px; border-width: 0;">
									<ul>
										<a href="/booking/cal" class="btmmenu"><li>월별 예약 현황</li></a>
										<br>
										<a href="/booking/new"><li>예약하기</li></a>
										<br>
										<a href="/booking/list"><li>전체 예약보기</li></a>
										<br>
									</ul>
								</div>
								<!-- end card-body -->
