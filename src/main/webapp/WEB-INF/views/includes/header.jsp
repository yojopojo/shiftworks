			...
			<div class="row">
				<div class="bottom-border pd-3" id="profile"
					...
					<div class="card-profile" style="">
						...
						<a href="#multiCollapseUser" class="" data-bs-toggle="collapse"
							...
							style="text-decoration: none; color: white;" id="userName">
				...
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseUser">
						<div class="card card-body" style="height: 140px; border-width: 0; margin-top: -15px;">
							<ul>
								<a href="/messenger/chat"
									onclick="window.open(this.href, '_blank', 'width=800, height=600'); return false;"><li>메신저</li></a> <br>
				...
				<div class="col">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a href="/task/pages/all/empty/empty/1"
							class="nav-link text-white p-3 mb-2 sidebar-link" data-bs-toggle="collapse" role="button" aria-expanded="false"
							aria-controls="multiCollapseTSK"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
				...
				<div class="col">
					<ul class="navbar-nav flex-column mt-4">
						<li class="nav-item"><a href="/schedule/main"
							class="nav-link text-white p-3 mb-2 sidebar-link"
							data-bs-toggle="collapse" role="button" aria-expanded="false"
							aria-controls="multiCollapseSCH"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
